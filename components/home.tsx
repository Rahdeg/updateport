    ...
    return (
        <section id='home' className='flex items-center justify-center gap-12 flex-col relative'>
            <div className=' grid grid-cols-1 lg:grid-cols-2 gap-4 w-full  '>
                <div className=' h-full w-full flex flex-col gap-4 items-center lg:items-start justify-center'>
                    ...
                    <p className=' text-base text-center text-texlight lg:text-left mt-6'>
