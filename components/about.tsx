            ...
            <div className=' grid grid-cols-1 lg:grid-cols-2 gap-4 w-full  '>
                ...
                <div className=' w-full px-8 flex flex-col gap-4 items-start justify-start'>
                    <p className=' text-white text-base lg:text-lg  tracking-wide text-justify'>
                        I create interactive experiences for people using modern web technology, I leverage HTML, CSS, Tailwind, React, Next.js, Node.js, MongoDB, MySQL, and a host of other tools to craft engaging and functional websites. My journey in this realm spans over four years, during which I have honed my skills, embraced challenges, and thrived in delivering exceptional digital experiences.
                    </p>
                </div>
            </div>
        </section>
